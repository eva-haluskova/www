...
<div class="content-margin-bottom-create">
    ...
    <table class="table table-hover family-font">
        <thead>
            <tr>
                <th>Spravovanie kategórií</th><th></th>
            </tr>
        </thead>
...
<!--        toto bude skryte divko, hahahahahaha-->
    <div id="addTypeForm">
        <form  method="post" name="myForm" action="?c=types&a=store">
            ...
            <div class="flex-rule">
                <textarea class="form-control flex-rule-child commeten-area" rows="1" placeholder="Pridaj kategoriu..." id="type" name="name" ></textarea>
